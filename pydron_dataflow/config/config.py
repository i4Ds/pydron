...
def load_config(configfile=None):
    ...
    if not configfile:
        ...
        candidates.append(os.path.abspath("pydron_dataflow.conf"))
        candidates.append(os.path.expanduser("~/pydron_dataflow.conf"))
        candidates.append("/etc/pydron_dataflow.conf")
...
def _create_starters(conf, rpcsystem):
    ...
    for i in range(conf["cores"]):
        ...
        smart = smartstarter.SmartStarter(starter,
                                          ...
                                          list(preload_packages) + [pydron_dataflow],
