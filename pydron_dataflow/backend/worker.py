...
from pydron_dataflow.interpreter import traverser
import time
import datetime
from pydron_dataflow.importhook import hook
...
class WorkerStarter(object):
    ...
    def __init__(self, smartstarter):
        ...
        self.smartstarter.preloaded_packages.append(pydron_dataflow)
